							...
							<tr class="<?php if ($i%2!=0) echo 'info'?>">
								...
								<td>
									<div style="display: none;" class="supp<?php echo $value['id']?> alert alert-warning alert-dismissible fade in" role="alert">
								      ...
								      <button type="button" class="btn btn-danger" onclick="location.href='product-fp.php?reference=product-size&action=delete&id_product=<?php echo $id_product ?>&id=<?php echo $value['id'] ?>'">Oui !</button>
								 	</div>

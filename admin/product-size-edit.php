	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<h3>Edition des tailles de produits</h5>
		...
		<div class="row bg-info">
				...
				<input type="hidden" name="reference" value="product-size">
							...
							<tr class="<?php if ($i%2!=0) echo 'info'?>">
								...
								<td>
									<div style="display: none;" class="supp<?php echo $value['id']?> alert alert-warning alert-dismissible fade in" role="alert">
								      ...
								      <button type="button" class="btn btn-danger" onclick="location.href='product-fp.php?reference=product-size&action=delete&id_product=<?php echo $_GET['id_product'] ?>&id=<?php echo $value['id'] ?>'">Oui !</button>
								 	</div>
